...
#define BalancerSignalList \
    ...
    BalancerSignal(AD_C5,   BU_C5,  AllCompare, 0.003,  0.003,      0.5,      2) \
    BalancerSignal(AD_C6,   BU_C6,  AllCompare, 0.003,  0.003,      0.5,      2) \
    BalancerSignal(AD_C7,   BU_C7,  AllCompare, 0.003,  0.003,      0.5,      2) \
    BalancerSignal(AD_C8,   BU_C8,  AllCompare, 0.003,  0.003,      0.5,      2)
// clang-format on